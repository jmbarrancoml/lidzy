import { HingeDemo } from "@/components/hinge-demo";

const githubUrl = "https://github.com/jmbarrancoml/hinge";
  ...
  return (
    <main>
      <header className="nav shell">
        <a className="brand" href="#top" aria-label="Hinge home"><Mark />Hinge</a>
      ...
      <section className="hero shell" id="top">
        <div className="hero-copy">
          ...
          <p>Hinge folds, shades and softens your desktop as you close your MacBook. A small physical detail that makes the whole machine feel alive.</p>
        ...
        <div className="hero-demo"><HingeDemo compact /></div>
      </section>
      <section className="features shell" id="features">
        <p className="eyebrow">Features</p><h2>One motion. Your whole desktop.</h2>
        <div className="feature-grid">
          <article><small>01</small><h3>Follow the hinge</h3><p>Hinge reads the built-in lid angle sensor and responds to each degree of movement.</p></article>
          ...
          <article><small>03</small><h3>Stay private</h3><p>Everything runs on your Mac. Hinge never records, saves or uploads your screen.</p></article>
        </div>
        <HingeDemo />
      </section>
    ...
    return Effects(
      ...
      shade: (1 - progress) * 0.58
          ...
          <div className="open-copy">
            <h3>Hinge is yours to inspect, change and improve.</h3>
      ...
      <footer className="shell"><a className="brand" href="#top"><Mark />Hinge</a><div><a href={githubUrl}>GitHub</a><a href={`${githubUrl}/blob/main/LICENSE`}>License</a></div></footer>
    </main>
  );
}
